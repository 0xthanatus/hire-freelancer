      ...
      <section id="contact" className="">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center sm:text-xl">
            Still, have doubts? Got a technical issue? Want to send feedback
            about a beta feature? Need details about our Business plan? Let us
            know.
          </p>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              ...
              <input
                ...
                className="c-input shadow-sm  border border-gray-300 text-sm rounded-lg  block w-full p-2.5   "
            ...
            <div>
              ...
              <input
                ...
                className="c-input block p-3 w-full text-sm rounded-lg border border-gray-300 shadow-sm  "
            ...
            <button
              type="submit"
              className="py-3 px-5 text-sm bg-[#485ED8] rounded-md flex items-center gap-4"
            >
